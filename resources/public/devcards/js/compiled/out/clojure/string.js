...
{{
var G__16525 = cljs.core.pop.call(null,v__$1);
v__$1 = G__16525;
continue;
}
} else
...
{var pred__16529 = cljs.core._EQ_;var expr__16530 = limit;if(cljs.core.truth_(pred__16529.call(null,1,expr__16530)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__16529.call(null,2,expr__16530)))
...
var G__16532 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__16533 = (limit__$1 - 1);
var G__16534 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__16532;
limit__$1 = G__16533;
parts = G__16534;
continue;
...
{var ch = s.charAt(index);var temp__4124__auto___16536 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4124__auto___16536))
{var replacement_16537 = temp__4124__auto___16536;buffer.append([cljs.core.str(replacement_16537)].join(''));
} else
{buffer.append(ch);
}
{
var G__16538 = (index + 1);
index = G__16538;
continue;
}
}
