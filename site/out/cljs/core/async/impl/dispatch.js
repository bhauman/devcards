...
var count_48217 = (0);
while(true){
var m_48218 = cljs.core.async.impl.dispatch.tasks.pop();
if((m_48218 == null)){
} else {
m_48218.call(null);

if((count_48217 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE)){
var G__48219 = (count_48217 + (1));
count_48217 = G__48219;
continue;
} else {
}
}
