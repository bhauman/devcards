...
var count_46864 = (0);
while(true){
var m_46865 = cljs.core.async.impl.dispatch.tasks.pop();
if((m_46865 == null)){
} else {
m_46865.call(null);

if((count_46864 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE)){
var G__46866 = (count_46864 + (1));
count_46864 = G__46866;
continue;
} else {
}
}
