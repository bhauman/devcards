...
sablono.util.ToString = (function (){var obj73821 = {};
return obj73821;
})();
...
return (function (){var or__16062__auto__ = (sablono.util.to_str[goog.typeOf(x__16698__auto__)]);
if(or__16062__auto__){
return or__16062__auto__;
} else {
var or__16062__auto____$1 = (sablono.util.to_str["_"]);
...
sablono.util.ToURI = (function (){var obj73823 = {};
return obj73823;
})();
...
var x__16698__auto__ = (((x == null))?null:x);
return (function (){var or__16062__auto__ = (sablono.util.to_uri[goog.typeOf(x__16698__auto__)]);
if(or__16062__auto__){
return or__16062__auto__;
} else {
var or__16062__auto____$1 = (sablono.util.to_uri["_"]);
if(or__16062__auto____$1){
return or__16062__auto____$1;
} else {
...
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(argseq__17102__auto__);
});
...
sablono.util.as_str.cljs$lang$applyTo = (function (seq73824){
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq73824));
});
/**
...
var vec__73826 = clojure.string.split.call(null,cljs.core.name.call(null,k),/-/);
var first_word = cljs.core.nth.call(null,vec__73826,(0),null);
var words = cljs.core.nthnext.call(null,vec__73826,(1));
...
var G__73828 = clojure.set.rename_keys.call(null,m,kmap);
var G__73828__$1 = ((cljs.core.map_QMARK_.call(null,new cljs.core.Keyword(null,"style","style",-496642736).cljs$core$IFn$_invoke$arity$1(m)))?cljs.core.update_in.call(null,G__73828,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"style","style",-496642736)], null),sablono$util$camel_case_keys):G__73828);
return G__73828__$1;
} else {
return m;
}
...
var argseq__17102__auto__ = ((((0) < arguments.length))?(new cljs.core.IndexedSeq(Array.prototype.slice.call(arguments,(0)),(0))):null);
return sablono.util.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(argseq__17102__auto__);
});

sablono.util.merge_with_class.cljs$core$IFn$_invoke$arity$variadic = (function (maps){
var classes = cljs.core.vec.call(null,cljs.core.remove.call(null,cljs.core.nil_QMARK_,cljs.core.mapcat.call(null,(function (p1__73829_SHARP_){
if(cljs.core.list_QMARK_.call(null,p1__73829_SHARP_)){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__73829_SHARP_], null);
} else {
if(cljs.core.sequential_QMARK_.call(null,p1__73829_SHARP_)){
return p1__73829_SHARP_;
} else {
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__73829_SHARP_], null);
...
sablono.util.merge_with_class.cljs$lang$applyTo = (function (seq73830){
return sablono.util.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq73830));
});
/**
...
var vec__73834 = ((cljs.core.empty_QMARK_.call(null,matches))?(function(){throw cljs.core.ex_info.call(null,[cljs.core.str("Can't match CSS tag: "),cljs.core.str(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():(cljs.core.truth_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null).call(null,cljs.core.ffirst.call(null,matches)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["div",matches], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first.call(null,matches),cljs.core.rest.call(null,matches)], null)
));
var tag_name = cljs.core.nth.call(null,vec__73834,(0),null);
var names = cljs.core.nth.call(null,vec__73834,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,cljs.core.first.call(null,cljs.core.map.call(null,sablono.util.strip_css,cljs.core.filter.call(null,((function (matches,vec__73834,tag_name,names){
return (function (p1__73831_SHARP_){
return cljs.core._EQ_.call(null,"#",cljs.core.first.call(null,p1__73831_SHARP_));
});})(matches,vec__73834,tag_name,names))
,names))),cljs.core.vec.call(null,cljs.core.map.call(null,sablono.util.strip_css,cljs.core.filter.call(null,((function (matches,vec__73834,tag_name,names){
return (function (p1__73832_SHARP_){
return cljs.core._EQ_.call(null,".",cljs.core.first.call(null,p1__73832_SHARP_));
});})(matches,vec__73834,tag_name,names))
,names)))], null);
});
/**
 ...
 */
sablono.util.normalize_element = (function sablono$util$normalize_element(p__73835){
var vec__73838 = p__73835;
var tag = cljs.core.nth.call(null,vec__73838,(0),null);
var content = cljs.core.nthnext.call(null,vec__73838,(1));
...
var vec__73839 = sablono.util.match_tag.call(null,tag);
var tag__$1 = cljs.core.nth.call(null,vec__73839,(0),null);
var id = cljs.core.nth.call(null,vec__73839,(1),null);
var class$ = cljs.core.nth.call(null,vec__73839,(2),null);
...
var x__$1 = this;
if(cljs.core.truth_((function (){var or__16062__auto__ = x__$1.hasDomain();
